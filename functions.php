    ...
    if (!function_exists("theme_enqueue_styles")) {
        if (!is_admin()) {
            ...
            function theme_enqueue_styles() {
                ...
                wp_enqueue_style('googlefonts', 'https://fonts.googleapis.com/css?family=Josefin+Slab:400,300italic,300,400italic,600,700,600italic,700italic|Josefin+Sans:400,600,400italic,600italic,700,700italic|Merriweather:400,300,300italic,700,400italic,700italic|Lobster+Two', 'style', '1.0', 'all', array('child-style'));
